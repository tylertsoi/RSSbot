        ...
        public void run() {
            ...
            while (running) {
               ...
               if(!WeatherPubFeed.equals(WeatherPubDate) && isSubscribedWeather){
				   //sendMessage(sendMessageRequest);
				   String message = tryRSS.readRSSFeed(WeatherHandlers.weatherUrl,"Weather");
				   Message(WeatherHandlers.ChatId,message);
				   ...
				   String message = tryRSS.readRSSFeed(WeatherHandlers.warnUrl,"Warning");
				   Message(WeatherHandlers.ChatId,message);
